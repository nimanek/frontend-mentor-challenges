        ...
        <>
            <div className="relative left-4 md:left-0">
                ...
                <div className="absolute rounded-full top-32 z-50 md:left-58 shadow-xl/50 text-white">
                    ...
                    <span className="absolute bottom-14 left-5 w-[90%] tracking-[0.4rem] font-medium text-lg">0000 0000 0000 0000</span>
                    <span className="absolute right-5 bottom-4 text-xs">00/00</span>
                    <span className="absolute left-5 bottom-4 text-xs">name</span>
                </div>
                {/* Back card */}
                <div className="absolute rounded-full top-10 right-10 w-fit md:left-78 md:top-86 shadow-xl/30">
                    ...
                    <span className="absolute top-17 right-10 md:top-20">000</span>
                </div>
            </div>
        </>
    );
